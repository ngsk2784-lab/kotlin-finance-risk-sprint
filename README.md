...
무료 샘플은 검사 승인 권한과 고정 커밋을 확인한 공개 저장소에서 최대 20개 소스 파일 또는 5,000 LoC 중 먼저 도달하는 범위에 실행합니다. 산출물은 1쪽 이내 요약과 대표 후보 최대 3건이며 리미디에이션 슬롯은 포함되지 않습니다. 무료 샘플 또는 유료 스프린트의 범위 확인은 [ngsk2784@gmail.com](mailto:ngsk2784@gmail.com)으로 요청할 수 있습니다. 이메일이나 공개 이슈에 소스 코드, 토큰, 비밀번호, 실제 고객·금융 데이터를 첨부하지 마십시오.
